...
let s:palette.bg        = {'dark': "#404040",  'light': "#FAFAFA",  'mirage': "#212733"}

let s:palette.comment   = {'dark': "#7bcc7b",  'light': "#ABB0B6",  'mirage': "#5C6773"}
...
let s:palette.tag       = {'dark': "#d4d4d4",  'light': "#36A3D9",  'mirage': "#5CCFE6"}
let s:palette.regexp    = {'dark': "#95E6CB",  'light': "#4CBF99",  'mirage': "#95E6CB"}
let s:palette.string    = {'dark': "#f97f71",  'light': "#86B300",  'mirage': "#BBE67E"}
let s:palette.function  = {'dark': "#d4d4d4",  'light': "#F29718",  'mirage': "#FFD57F"}
let s:palette.special   = {'dark': "#E6B673",  'light': "#E6B673",  'mirage': "#FFC44C"}
let s:palette.keyword   = {'dark': "#eddb81",  'light': "#FF7733",  'mirage': "#FFAE57"}
...
let s:palette.fg        = {'dark': "#d4d4d4",  'light': "#5C6773",  'mirage': "#D9D7CE"}
