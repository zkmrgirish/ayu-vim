...
let s:fg.contrast   = {'dark': '#7bcc7b', 'light': '#86B300', 'mirage': '#BAE67E'}[s:style]
...
let s:bg = {}
let s:bg.primary    = {'dark': '#5f5f5f', 'light': '#DEE8F1', 'mirage': '#2A3546'}[s:style]
let s:bg.secondary  = {'dark': '#4f4f4f', 'light': '#F0F0F0', 'mirage': '#232838'}[s:style]
let s:bg.contrast   = {'dark': '#E6B450', 'light': '#FF9940', 'mirage': '#FFCC66'}[s:style]
let s:bg.normal     = {'dark': '#6f6f6f', 'light': '#D3D5D7', 'mirage': '#141925'}[s:style]
...
let s:bg.visual     = {'dark': '#7bcc7b', 'light': '#A37ACC', 'mirage': '#D4BFFF'}[s:style]
